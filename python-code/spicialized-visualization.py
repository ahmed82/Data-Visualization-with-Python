# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 13:47:48 2020
...
"""Step 2: Plot the data. In Matplotlib, we can create a scatter plot set by passing 
in kind='scatter' as plot argument. We will also need to pass in x and y keywords 
to specify the columns that go on the x- and the y-axis."""
...
# Question: Create a scatter plot of the total immigration from Denmark, Norway,
# and Sweden to Canada from 1980 to 2013?
